...
- 🌱 Estoy aprendiendo *Python, React, implementación de API´S y el uso continuo de IA tanto en el entorno de trabajo como en los proyectos**

- ☁️ Estoy interesado en la programación con Python aunque también tengo conocimientos con PHP, Java y JavaScript. Me estoy formando y trabajando de manera autónoma con **Python 3.13.7**

- 💬 Puedes preguntarme sobre **Python, PHP, Java, JavaScript, Symfony, HTML, CSS, Bootstrap, SQL, GIT, GITHUB, ORACLE, **

- 📫 Puedes contactarme por **oscarcontactweb@gmail.com**
<!--Intro end-->
